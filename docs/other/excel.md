...
## excel将设置百分比的单元格设置百分比背景色

单元格设置为百分比格式

数据-条件格式-新建规则-数据条-自定义格式-数字最大0最小1
...
## 在第二个页签里面想做A列的下拉，下拉数据来自第一个页签的B列（但不能是B1）

公式-名称管理器：

- 名称：所有企业名称（取个变量名）
- 引用：`=OFFSET(企业信息!$B$2,0,0,COUNTA(企业信息!$B:$B)-1)`
- 企业信息就是第一个页签的名称

第二个页签A列：设置下拉列表=所有企业名称
